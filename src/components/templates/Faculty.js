...
// import SdcFacultyData from "../components/SdcFacultyData";
import SdcFaculty from "../templates/SdcFaculty";
import facultyData from "../../Data/SdcFacultyData";

function data(val) {
  return <SdcFaculty name={val.name} description={val.description} />;
}
...
const Faculty = () => {
  return (
    <div>
      <SdcCarousel />
      {/* <SdcFaculty name={facultyData[0].name} /> */}
      {/* <div>hello</div> */}
      {/* <SdcFaculty /> */}
