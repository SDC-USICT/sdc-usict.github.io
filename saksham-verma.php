<?php include 'sdcusict2022header.php' ?>
  ...
  <style>
    ...
    <div class="container__flex">
      <div class="profile__div saksham-verma">
        <div class="profile__photo">
          <img class="profile__img" src="./students-img/saksham-verma.jpg" alt="" />
        </div>
      </div>
      <div class="social__div">
        <div class="social__heading">
          <h3 class="heading__name team-heading">Saksham Varma</h3>
          <p class="heading__desg">Graphics Team</p>
          <p class="heading__desg">Lead

          </p>
        </div>
        <div class="social__icons">
          <a href="https://www.linkedin.com/in/saksham-varma-45a218209/" target="_blank" class="social__icon">
            <img src="./linkedin-circle.png" alt="" />
          </a>
          <a href="https://github.com/SakshamVarma" target="_blank" class="social__icon">
            <img src="./github-circle.png" alt="" />
          </a>
          <a href="mailto:saksham.varma02@gmail.com" target="_blank" class="social__icon">
      ...
      <div class="myself__div">
        <div class="myself__divinside">
          ...
          Enthusiastic Android Developer in Kotlin with Internship experience and expanding my knowledge of Data Structures and Algorithms
          </p>
      ...
      <div class="project__div">
        ...
        <div class="project__cards">
          <div class="project__card">
            <h3 class="project__title black__color">Newzify</h3>
            <p style="text-align: left;" class="project__content black__color">
            Shows up-to-date NEWS using the Newsapi.org REST-API
            </p>
            <button class="button project__button"><a href="https://github.com/SakshamVarma/Newzify-REST-API-NEWS-APP" target="_blank">See Projects</a></button>
          </div>
          <div class="project__card">
      ...
      <div class="skill__div">
        ...
        <div class="skill__cards">
          <div class="skill__card">
            ...
            -Firebase
            -XML
            -REST Libraries - Retrofit2, Volley"
            </p>
          </div>
        </div>
      </div>
      <div class="exp__div container">
        ...
        <div class="exp__details">
          <div class="exp__detail">
            <h2 class="exp__heading team-heading">SDC Lead</h2>
        ...
        <div class="exp__details">
          <div class="exp__detail">
            <h2 class="exp__heading team-heading">Android Developer Intern at BestBai</h2>
