    ...
    <div class="container__flex">
      ...
      <div class="social__div">
        <div class="social__heading">
          <h3 class="heading__name team-heading">Kartik Khatana</h3>
          <p class="heading__desg">Developer</p>
        </div>
        <div class="social__icons">
          <a href="https://www.linkedin.com/in/kartikkhatana/" target="_blank" class="social__icon">
            <img src="./linkedin-circle.png" alt="" />
          </a>
          <a href="https://github.com/kartikkhatana" target="_blank" class="social__icon">
            <img src="./github-circle.png" alt="" />
          </a>
          <a href="mailto:kartikkhatana1@gmail.com" target="_blank" class="social__icon">
      ...
      <div class="project__div">
        ...
        <div class="project__cards">
          <div class="project__card">
            <h3 class="project__title black__color">Cantify </h3>
      ...
      <div class="exp__div container">
        ...
        <div class="exp__details">
          ...
          <p class="black__color exp__position">App developer</p>
        </div>
        <div class="exp__details">
          <div class="exp__detail">
            <h2 class="exp__heading team-heading">Fiverr.com</h2>
            <p class="black__color exp__time">August 2021 – Present</p>
          </div>
          <p class="black__color exp__position">Freelancer</p>
        </div>
        <div class="exp__details">
          <div class="exp__detail">
            <h2 class="exp__heading team-heading">pgbuddy.in</h2>
            <!-- <p class="black__color exp__time">November 2021 – Present</p> -->
          </div>
          <p class="black__color exp__position">Android Intern</p>
        </div>
      </div>
    </div>
