    ...
    <div class="container__flex">
      ...
      <div class="social__div">
        ...
        <div class="social__icons">
          ...
          <a href="https://github.com/sharma-tanishq" target="_blank" class="social__icon">
      ...
      <div class="myself__div">
        <div class="myself__divinside">
          ...
          I am a software developer who loves developing and improving algorithms. My hobbies include volleyball, programming.
          </p>
      ...
      <div class="project__div">
        ...
        <div class="project__cards">
          <div class="project__card">
            <h3 class="project__title black__color">NotesOnTheGo</h3>
            <p style="text-align: left;" class="project__content black__color">
            A Web App that let you store your notes, to-do list, memos and many such things
            </p>
            <button class="button project__button"><a href="http://notes-on-the-go.herokuapp.com" target="_blank">See Projects</a></button>
          </div>
      ...
      <div class="skill__div">
        ...
        <div class="skill__cards">
          <div class="skill__card">
            ...
            WebDevelopment, Algorithms and Data Structures, ReactJS, React Native
            </p>
          </div>
      ...
      <div class="exp__div container">
        ...
        <div class="exp__details">
          <div class="exp__detail">
            <h2 class="exp__heading team-heading">SFS Lead at SDC USICT</h2>
        ...
        <div class="exp__details">
          <div class="exp__detail">
            <h2 class="exp__heading team-heading">Full Stack Intern at Chaalk</h2>
